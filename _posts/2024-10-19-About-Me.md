...
* **A Holistic Approach to Non-Terrestrial 5G Networking with LEO Satellites: Algorithms, Experiments, and Insightss** \
 N. Cameron Matson, *<b>Yu-Tai Lin</b>*<span style="color:grey">, and Karthikeyan Sundaresan </span>\
 Proc. ACM Netw., 3, <span style="color:blue">(CoNext4)</span>, 2025\
 [\[paper\]](https://dl.acm.org/doi/abs/10.1145/3769001)

* **Bringing Collaborative Positioning to Native 5G Systems for Enhanced 2D & 3D Location Services** \
 *<b>Yu-Tai Lin</b>*<span style="color:grey">, N. Cameron Matson, and Karthikeyan Sundaresan </span>\
 Proc. ACM Netw., 2, <span style="color:blue">(CoNext4)</span>, 2024\
 [\[paper\]](https://dl.acm.org/doi/abs/10.1145/3696380)
...
<div class="container">
    <div class='row vspace-top'>
        <div class='div1'>
            <img class='icon-image' src='{{site.baseurl}}public/hpe.jpg'>
            <div>
                <b>Research Associate Intern</b> <br/>
	            <i>Hewlett Packard Labs</i> <br/>
                May. 2025 - Present <br/>
                Milpitas, CA, USA <br/>
            </div>
        </div>
